...
public class MeteorSpawnerRight : MonoBehaviour
{
    ...
    public float meteorSpeed = 5f;  // Speed of the meteor's leftward movement
    ...
    void SpawnMeteor()
    {
        ...
        Destroy(meteor, 10f);  // Optional: Destroy after 10 seconds as a safety measure
        SpawnMeteorWithRandomInterval();
    }
}
